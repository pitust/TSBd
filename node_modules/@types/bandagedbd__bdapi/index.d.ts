...
/**
 * Options to showConfirmationModal
 */
...
export namespace BdApiModule {
     ...
     */
    function showConfirmationModal(title: string, content: string | React.ReactElement | (string | React.ReactElement)[], optioms: IConfirmationModalOptions): string;
}
